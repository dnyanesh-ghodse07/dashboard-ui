...
export const Sidebar = () => {
  ...
  return (
    <Box sx={{ flexGrow: 1, paddingLeft: `${50}px` }}>
      <AppBar sx={{ background: "#fff" }} position="fixed">
        <Grid container justifyContent="flex-end">
          ...
          >
            <SearchIcon
              color="red"
              sx={{ position: "absolute", left: "0", marginLeft: "8px" }}
            />
            <TextField
